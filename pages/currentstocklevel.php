      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a class="opacity-5 text-dark" href="inventory.php">Inventory</a></li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Current Stock Levels</h6>
        </nav>
                ...
                <div class="col-md-6 col-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0"><a href="rawmaterials.php">Raw Materials</a></h6>
                ...
                <div class="col-md-6 col-6">
                  <div class="card">
                    <div class="card-header mx-4 p-3 text-center">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="40" height="60"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Work In Progress(WIP)</h6>
                      <span class="text-xs"></span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0"></h5>
                    </div>
              ...
              <div class="row">
                <div class="col-md-6 col-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Finished Goods</h6>
                      <span class="text-xs"></span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0"></h5>
                    </div>
