      ...
      <ul class="navbar-nav">
       ...
       <a class="nav-link text-white"  href="../pages/inventory.php">
            ...
            <a href="batchflockrecord.php">
                <i class="bi bi-circle"></i><span>Batch Flock Records</span>
              </a>
            </li>
            <li>
              <a href="">
                <i class="bi bi-circle"></i><span>Current Stock Levels</span>
              </a>
            </li>
            <li>
              <a href="components-badges.html">
                <i class="bi bi-circle"></i><span>Egg Production</span>
              </a>
            </li>
            <li>
              <a href="components-badges.html">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize"><a href="inventory.php">Inventory</a></p>
                <h4 class="mb-0">200 tons</h4>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize"><a href="supplier.php">Supplier</a></p>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize"><a href="orders.php">Orders</a></p>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                © 
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank"> SG Farms <br> Kosgama Sri Lanka</a> 
